    ...
    demo_users = [
        {
            ...
            'bio': 'Full-stack developer from Bangalore. Passionate about teaching Python and learning new frameworks.',
        ...
        },
        {
            ...
            'bio': 'UX designer from Hyderabad. Love collaborating on creative projects and learning to code.',
        ...
        },
        {
            ...
            'bio': 'Data scientist from Delhi. Always looking to exchange skills and learn something new!',
        ...
        },
        {
            ...
            'bio': 'Backend engineer from Pune. Specializing in cloud infrastructure. Teaching Docker & AWS.',
            'location': 'Pune, India',
        ...
        },
        {
            ...
            'bio': 'Digital marketer from Kochi. Fluent in 3 Indian languages. SEO specialist.',
            ...
            'xp': 55,
            'level': 3,
            'teach': [('Digital Marketing', 'Expert'), ('SEO', 'Advanced'), ('Social Media Marketing', 'Expert')],
            'learn': [('Python', 'Beginner'), ('Photography', 'Intermediate')],
        },
        {
            'name': 'Rohan Verma',
            'email': 'rohan@example.com',
            'bio': 'Mobile developer from Jaipur. Expert in Swift and Kotlin, learning web dev.',
            ...
            'xp': 78,
            'level': 4,
            'teach': [('Swift', 'Expert'), ('Kotlin', 'Advanced'), ('Java', 'Advanced')],
            'learn': [('Vue.js', 'Beginner'), ('CSS', 'Intermediate')],
        },
        {
            'name': 'Kavitha Iyer',
            'email': 'kavitha@example.com',
            'bio': 'Project manager from Chennai. Love helping others organize their work and learn new skills.',
        ...
        },
        {
            ...
            'bio': 'Music producer from Mumbai. Teach music production, learn to code.',
        ...
        },
        {
            ...
            'bio': 'Frontend developer from Nagpur. Passionate about accessible UIs and clean code.',
            ...
            'learn': [('Machine Learning', 'Beginner'), ('Writing', 'Intermediate')],
        },
        {
            'name': 'Karthik Menon',
            'email': 'karthik@example.com',
            'bio': 'Database administrator from Trivandrum. SQL expert. Also into photography.',
